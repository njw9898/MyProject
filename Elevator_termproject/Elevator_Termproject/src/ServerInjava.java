...
public class ServerInjava extends Thread{
	...
	ArrayList<elevator> allelevator;
	ArrayList<Businessman> allMan;

	public int[] floor_count;

	public ServerInjava(MainFrame hf,  ArrayList<elevator> allele, 	ArrayList<Businessman> allMan, int[] floor_count){
		this.hf = hf;
		this.allelevator = allele;
		this.allMan = allMan;
		this.floor_count=floor_count;
	}
	
	public void ServerInjavago() {
		...
		try {
			...
			while(true){
				...
				//대화용 쓰레드 생성 및 소켓
				ServerThread serverThread = new ServerThread(connectList, client, hf, allelevator, allMan, floor_count);
