...
public class Asteroid_Script : MonoBehaviour 
{
	...
	{ 
		...
		//When Asteroid is triggered to laser, go to if statement
		if(other.tag == "PlayerLaser")	// string type , it work distinguishing object 
		{
			//	LaserGreenHit : when asteroid meet laser 
